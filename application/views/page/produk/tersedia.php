				...
				<div class="col-md-4">
					...
					<div class="panel panel-danger mypan">
						...
						<ul class="list-group list-group-flush">
							<a href="<?=site_url('produk')?>"><li class="list-group-item link-artikel"><h5>Semua Produk</h5></li></a>
							<a href="<?=site_url('produk/tersedia')?>"><li class="list-group-item link-artikel" style="background:#e9454b;"><h5 style="color:#fff;">Produk Tersedia</h5></li></a>
